...
namespace OpdrachtDierenasiel1
{
    ...
    public abstract class Huisdier : IDier, ICloneable
    {
        ...
        public Huisdier(String chipnummer, int geboortejaar, String roepnaam, bool gereserveerd, Image foto)
        {
            String s = chipnummer;
            while (s.Length < 5)
            {
        ...
        /// </summary>
        public Huisdier()
            :this("00000", 0, "noname", false, null)
        {      
        }
        ...
        /// <summary>
        /// Reserveringsstatus van het huisdier
        /// </summary>
