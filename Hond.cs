...
namespace OpdrachtDierenasiel1
{
    ...
    public class Hond : Huisdier
    {
        ...
        /// <param name="foto">een foto van het huisdier</param>
        public Hond(string chipnummer, int geboortejaar, string roepnaam, bool gereserveerd, Image foto)
            : base(chipnummer, geboortejaar, roepnaam, gereserveerd, foto)
        {
           //moet je nog maken
        }
        ...
        {
            //moet je nog maken
            return string.Format("HOND: {0}, {1}:{2}:{3}", base.GetInfo(), 
                          uitlaatdag.ToString("00"), uitlaatmaand.ToString("00"), uitlaatjaar.ToString("0000") );            
        }
        ...
        /// </summary>
        /// <returns></returns>
        public override int GetPrijs()
        {
            return (Convert.ToInt32(Chipnummer) < 50000 ? 200 : 350);                                  
        }

        /// <summary>
        /// Geef de laatste uitlaatdatum door
        /// </summary>
        /// <param name="d">dag</param>
        /// <param name="m">maand</param>
        /// <param name="j">jaar</param>
        public void WijzigUitlaatDatum(int d, int m, int j)
        {
            this.uitlaatdag = d;
            this.uitlaatmaand = m;
            this.uitlaatjaar = j;
