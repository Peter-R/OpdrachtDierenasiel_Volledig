...
namespace OpdrachtDierenasiel1
{
    ...
    public class Kat : Huisdier
    {
        ...
        public Kat(String chipnummer, int geboortejaar, String roepnaam, bool gereserveerd, String extraInfo, Image foto) 
        ...
        {
            //moet je nog maken            
            return string.Format("KAT: {0}, {1}", base.GetInfo(), extraInfo);
        }
        ...
        {
            int prijs = 60 - extraInfo.Length;
            return (prijs < 20 ? 20 : prijs);
        }
    }
}
